    ...
    <div class=" flex flex-row flex-wrap gap-6 justify-stretch items-stretch">
        ...
        <Card.Root class="flex-grow">
            <Card.Header>
                ...
                <Card.Description>
                    Select fields using the checkboxes, and set values to update
                    for all scanned samples. You can also add mods that will be
                    applied with the changes.
                </Card.Description>
            </Card.Header>
            <Card.Content>
                <div class="flex flex-col gap-4 mb-4 h-full">
                    ...
                    <div class="flex flex-row gap-2">
                        <Checkbox
                            bind:checked={updateState}
                            id="state-update-enabled" />
                        <div class="flex-grow">
                            <Label
                                class="font-bold flex items-center gap-2 mb-2"
                    ...
                    <div class="flex flex-row gap-2">
                        <Checkbox
                            bind:checked={updateOwner}
                            id="owner-update-enabled" />
                        <div class="flex-grow">
                            <Label
                                class="font-bold flex items-center gap-2 mb-2"
                            ...
                            <Input
                                ...
                                onkeydown={(e) => {
                                    if (e.key === 'Enter' && modInput.trim()) {
                                        e.preventDefault();
                                        if (
                                            !modNames.includes(modInput.trim())
                                        ) {
                                            modNames = [
                                                ...modNames,
                                                modInput.trim(),
